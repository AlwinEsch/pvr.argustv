...
class CStreamRecording : public kodi::addon::CInstanceInputStream
{
public:
  CStreamRecording(const CArgusTVAddon& base, KODI_HANDLE instance, const std::string& kodiVersion);
